...
find_library(PYTHONQT_LIBRARY_RELEASE PythonQt PATHS "${PYTHONQT_ROOT_DIR}/lib" DOC "The PythonQt library.")
find_library(PYTHONQT_QTALL_LIBRARY_RELEASE PythonQt_QtAll PATHS "${PYTHONQT_ROOT_DIR}/lib" DOC "The PythonQt library.")
find_library(PYTHONQT_LIBRARY_DEBUG libPythonQt_d.a PATHS "${PYTHONQT_ROOT_DIR}/lib" DOC "The PythonQt library.")
find_library(PYTHONQT_QTALL_LIBRARY_DEBUG libPythonQt_QtAll.a PATHS "${PYTHONQT_ROOT_DIR}/lib" DOC "The PythonQt library.")
